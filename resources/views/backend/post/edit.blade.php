    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Masukkan judul"  value="{{$post->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="added_by">Pengguna</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>Non Aktif</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
