    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input type="text" name="size" class="form-control" placeholder="Contoh: 120 x 60 x 75">
          </select>
        </div>
          ...
          <div class="form-group">
              ...
              <input type="text" id="custom-material" name="custom_material" class="form-control mt-2" placeholder="Masukkan bahan lain" style="display: none;">
