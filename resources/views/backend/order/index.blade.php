...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      {{-- <a href="{{route('order.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="tambah order"><i class="fas fa-plus"></i> Tambah Pesanan</a>
    </div> --}}
 </div>
    <div class="card-body">
