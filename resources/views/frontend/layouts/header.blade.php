                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @auth 
                                ...
                                <li><i class="fa fa-truck"></i> <a href="{{route('order.track')}}">Lacak Pesanan</a></li>
                            ...
                            @else
                                <li><i class="fa fa-sign-in";></i><a href="{{route('login.form')}}">Login /</a> 
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            ...
                            <form method="POST" action="{{route('product.search')}}">
                                @csrf
                                <input name="search" placeholder="Cari Produk....." type="search">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('wishlist')}}">Lihat Daftar Wishlist</a>
                                    </div>
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">Produk<span class="new">New</span></a></li>												
                                                {{Helper::getHeaderCategory()}}
                                            <li class="{{Request::path()=='blog' ? 'active' : ''}}"><a href="{{route('blog')}}">Blog</a></li>									
                                               
                                            <li class="{{Request::path()=='contact' ? 'active' : ''}}"><a href="{{route('contact')}}">Hubungi Kontak</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
