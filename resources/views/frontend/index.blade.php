...
@section('title','Lana-Jati Furnitur || HOME PAGE')
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item {{(($key==0)? 'active' : '')}}">
                    ...
                    <div class="carousel-caption d-none d-md-block text-left">
                        ...
                        <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-grids')}}" role="button">Belanja Sekarang juga<i class="far fa-arrow-alt-circle-right"></i></i></a>
                    </div>
                </div>
            @endforeach
        </div>
                    ...
                    @if($cat->is_parent==1)
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-banner">
                                ...
                                <div class="content">
                                    <h3>{{$cat->title}}</h3>
                                        <a href="{{route('product-cat',$cat->slug)}}">Temukan Sekarang</a>
                                </div>
                            </div>
                        </div>
                    @endif
            ...
            <div class="single-product">
                <div class="product-img">
                    <a href="{{route('product-detail', $product->slug)}}">
                        ...
                        @elseif($product->material == 'Jati')
                            <span class="Jati">Jati</span>
                        @elseif($product->material  == 'Mahoni')
                            <span class="Mahoni">Mahoni</span>
                            @elseif($product->material  == 'Randu')
                            <span class="Randu">Randu</span>
                        @else
                    ...
                    <div class="button-head">
                        <div class="product-action">
                            <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class="ti-eye"></i><span>Lihat Detail</span></a>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            <div class="content">
                                ...
                                <a href="{{route('product-detail',$data->slug)}}">Temukan Sekarang</a>
                            </div>
                        </div>
                    </div>
                    <!-- /End Single Banner  -->
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a href="{{route('add-to-cart',$product->slug)}}">Tambahkan ke Keranjang</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            ...
                            <div class="content">
                                ...
                                <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Baca Selengkapnya</a>
                            </div>
                        </div>
                        <!-- End Single Blog  -->
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    <i class="ti-reload"></i>
                    <h4>Barang dengan ukiran khas Jepara</h4>
                    <p>
                        barang dengan bahan berkualitas</p>
                </div>
                <!-- End Single Service -->
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> ({{$rate_count}} review pelanggan)</a>
                                            </div>
                                            <div class="quickview-stock">
                                                @if($product->stock >0)
                                                <span><i class="fa fa-check-circle-o"></i> {{$product->stock}} di stok</span>
                                                @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} keluar stok</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
