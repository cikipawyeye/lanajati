...
@section('title','Lana-jati Furnitur || PRODUCT PAGE')
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									<h3 class="title">Sortir Harga</h3>
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
											...
											<div class="row">
														...
														<div class="product-img">
															...
															<div class="button-head">
																...
																<div class="product-action-2">
																	<a title="Tambahkan ke Keranjang" href="{{route('add-to-cart',$product->slug)}}">Tambahkan ke Keranjang</a>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">Tambahkan ke Keranjang</a>
													</div>
												</div>
											</div>
										</div>
									...
									@endforeach
								@else
									<h4 class="text-danger" style="margin:100px auto;">Maaf, tidak ada produk sesuai dengan rentang yang diberikan. Coba cari lagi</h4>
								@endif
							</div>
							 <div class="row">
											...
											<div class="quickview-content">
												...
												<div class="quickview-ratting-review">
													...
													<div class="quickview-stock">
														...
														@else 
														<span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} kosong</span>
														@endif
													</div>
												</div>
												@php
