					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">Tambahkan ke keranjang</th> 
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount" data-title="Total"><span>Rp.{{$wishlist->amount * $wishlist->quantity}}</span></td>
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Tambahkan ke keranjang</a></td>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<i class="ti-rocket"></i>
						<h4>Free Ongkir</h4>
						<p>Untuk area tertentu dan minimal belanjaan</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
