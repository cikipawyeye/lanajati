...
@endsection
@section('title','Lana jati furnitur || PRODUCT DETAIL')
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											@if($product_detail->material)
												<div class="material mt-5">
													<h5>Material</h5>
													<ul>
														@php 
															$material = explode(',', $product_detail->material);
														@endphp
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>Alamat email Anda tidak akan diunggah. Kolom yang dianjurkan diisi</p>
																	</div>
																	<h4>Penilaianmu <span class="text-danger">*</span></h4>
																...
																<p class="text-center p-5">
																	Anda perlu <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('register.form')}}">Register</a>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                ...
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Tambahkan ke Compare</span></a>
                                            </div>
