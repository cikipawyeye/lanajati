 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @endphp
            @foreach($reviews as $review)
                <tr>
                    ...
                    <td>
                        <a href="{{route('user.productreview.edit',$review->id)}}" class="btn btn-primary btn-sm float-left mr-1" 
                          style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom">
        ...
        @else
          <h6 class="text-center">Belum Ada Riview!!!</h6>
        @endif
      </div>
    </div>
</div>
